...
var MonthPicker = /** @class */ (function (_super) {
    ...
    */
    function MonthPicker(props) {
        ...
        _this.PAGE_WIDTH = exports.PAGE_WIDTH;
        return _this;
    }
    ...
    MonthPicker.prototype.getSelectableCellPositions = function () {
        var _this = this;
        return _.filter(_.range(0, exports.MONTHS_IN_YEAR), function (m) { return !_.includes(_this.getDisabledPositions(), m); });
    };
